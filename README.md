...
1. Rules on clear space, forbidden alterations, and the monochromatic OKLCH color system.
2. The technical specification of the Cartesian coordinate space and cubic Bézier curves that form the logo.
